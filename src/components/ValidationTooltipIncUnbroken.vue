            ...
            <div
                ...
                <ul>
                    <li class="rule-rule" :class="(rule.broken ? 'broken' : null)" v-for="rule in rules" :key="rule.text">
                      <div>
                        <svg v-if="rule.broken" xmlns="http://www.w3.org/2000/svg" height="16px" viewBox="0 -960 960 960" width="16px" fill="var(--error-normal)"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg>
                        <svg v-else xmlns="http://www.w3.org/2000/svg" height="16px" viewBox="0 -960 960 960" width="16px" fill="var(--text-primary)"><path d="M382-240 154-468l57-57 171 171 367-367 57 57-424 424Z"/></svg>
                        <p>{{ rule.text }}</p>
                      </div>
                    </li>
                </ul>
...
.container {
    padding: 8px 12px;
    border: solid var(--neutral-600) var(--border-width);
